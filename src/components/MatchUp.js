...
const MatchUp = (props) => {
        ...
        return (<div className={`matchup R${props.round_number}-M${props.matchUp.match_up_number}`}>
            ...
            if (props.matchUp.winner_id){
                ...
                return (<div className={`matchup R${props.round_number}-M${props.matchUp.match_up_number}`}>
                         <Row >
                            {props.matchUp.team_a?  <button type="button" className={`btn btn-light teamButton `}> {props.matchUp.team_a.name}</button> : 
                                <Button type="button" className={`btn btn-light teamButton`} disabled>&nbsp; </Button>
                            }
                        </Row>
                        <Row  >
                            {props.matchUp.team_b?  <button  type="button" className={`btn btn-dark teamButton `}  > {props.matchUp.team_b.name}</button> : 
                                <Button type="button" className={`btn btn-dark teamButton` } disabled> &nbsp;  </Button>
                            }
                        </Row>
                        <SteppedLineTo  borderColor={'grey'} from={`R${props.round_number}-M${props.matchUp.match_up_number}`} to={`R${nextRound}-M${nextMatchUp}`} toAnchor={props.start}  fromAnchor={props.end}  orientation='h' />
                ...
                return (<div className={`matchup R${props.round_number}-M${props.matchUp.match_up_number}`}>
                         <Row  >
                            <Button type="button" className={`btn btn-light teamButton `} > {props.matchUp.team_a.name}</Button> 
                        </Row>
                        <Row  >
                            <Button  type="button" className={`btn btn-dark teamButton `} > {props.matchUp.team_b.name}</Button>       
                        </Row>
                        <SteppedLineTo borderColor={'grey'} from={`R${props.round_number}-M${props.matchUp.match_up_number}`} to={`R${nextRound}-M${nextMatchUp}`} toAnchor={props.start}  fromAnchor={props.end}  orientation='h' />
                </div>)}
